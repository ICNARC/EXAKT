/*******************************************************************************
Project: EXAKT
Do file for: Adjusted Arms
*******************************************************************************/


cap log close
log using PredictingARMS, replace text
...
putexcel set "${OutputDir}\\Measurement accuracy - ARMS", modify sheet("Adjusted")
excel
forval i = 1/6 {
	forval j = 1/7 {

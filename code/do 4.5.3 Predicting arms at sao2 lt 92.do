/*******************************************************************************
Project: EXAKT
Do file for: Adjusted Arms over SaO2 < 92
*******************************************************************************/
...
keep pid spfrac safrac t1 t2 t3 s1 s2 s3 h1 h2 h3 o skincat SquaredError
...
// 		return scalar arms_range`i' = 100*abs(sqrt(`o`i'_s5') - sqrt(`o`i'_s1')) ** AC 27FEB2024 updated
	...
	* run estimation
	...
	putexcel set "${OutputDir}\\Measurement accuracy 92 - ARMS", modify sheet("Adjusted <=92")

/*******************************************************************************
Project: EXAKT
Do file for: Adjusted precision at fixed values of SaO2
*******************************************************************************/

cap log close
log using PredictingRMSEatSaO2, replace text
...
* Looping over potential SAO2 values of interest 
foreach i in 88 92 94 96 {
	...
	* run estimation
	...
	putexcel set "${OutputDir}\\Measurement accuracy - RMSE", modify sheet("Adjusted `i'")
	excel
	forval i = 1/6 {
		forval j = 1/7 {

/*******************************************************************************
Project: EXAKT
Do file for: Adjusted bias over SaO2 < 92
*******************************************************************************/
...
keep pid spfrac safrac t1 t2 t3 s1 s2 s3 h1 h2 h3 o skincat
...
prog pr_bias_sao2, rclass
	...
	* output results
	putexcel set "${OutputDir}\\Measurement accuracy 92 - Bias", modify sheet("Adjusted <=92")
	forval i = 1/6 {
		forval j = 1/7 {
